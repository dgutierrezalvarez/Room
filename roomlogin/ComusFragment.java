...
import com.company.roomlogin.databinding.FragmentComusBinding;
import com.company.roomlogin.viewmodel.AutenticacionViewModel;

public class ComusFragment extends Fragment {
    private FragmentComusBinding binding;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        return (binding = FragmentComusBinding.inflate(inflater, container, false)).getRoot();
