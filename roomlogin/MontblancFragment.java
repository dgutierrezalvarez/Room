...
import com.company.roomlogin.databinding.FragmentMontblancBinding;
...
public class MontblancFragment extends Fragment {
    private FragmentMontblancBinding binding;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        return (binding = FragmentMontblancBinding.inflate(inflater, container, false)).getRoot();
