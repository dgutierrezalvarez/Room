...
import com.company.roomlogin.databinding.FragmentPrehistoriaBinding;
import com.company.roomlogin.viewmodel.AutenticacionViewModel;

public class PrehistoriaFragment extends Fragment {
    private FragmentPrehistoriaBinding binding;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        return (binding = FragmentPrehistoriaBinding.inflate(inflater, container, false)).getRoot();
